...
---
# Новости обновления (version 0.54) – Изменение расписания

- #### Изменены: 
	- **Раздел «Расписание»**. Расписание стало более развернутым и удобным. Вы можете ознакомится с ним на [[Добро пожаловать в STUDENT!|главной странице]] или при помощи кнопки :OcCalendar16: расписание в левом верхнем углу;
	- Удалены лишние кнопки в панели управления.

- #### Плановые обновления
	- [[Компьютерные сети]]. Добавление новых лекций;
	- [[Поддержка и тестирование программных модулей]]. Добавление новых лекций и практических заданий;
	- **Раздел «Правила написания работ»**. Раздел библиотеки, посвящённый правилам оформления дипломных, курсовых, практических и других подобных работ.
	- **Мобильная версия STUDENT**. Инструкция по установке мобильной версии STUDENT и доступ к базе данных.
