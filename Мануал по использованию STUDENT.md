...
- **Практические задания**. В большинстве лекций есть ссылки на практический материал. Всю практику можно найти отдельно. Откройте интересующий вас предмет и найдите папку *«Практический материал»* или откройте страницу предмета;

![[Видео 16-05-2024 195319.mp4]]

- **Книги**. Если вы хотите более подробно изучить материал, то в **STUDENT** содержатся много интересных книг для глубокого обучения. Найти вы их сможете в соответствующем разделе на главной странице или на странице предмета;
...
Для максимальной правильности и эффективности ведения пар рекомендуется выполнять следующие действия касательно расписания:

1. **Заполните пару на сегодняшний день.** 
	1. *Если не создана:*
		1. **Откройте расписание**. Откройте расписание :OcCalendar24: в левом верхнем углу и выберете день на который назначена пара. Для создания достаточно просто кликнуть по пустой области. 
		...
		3. **Откройте созданное событие**. Выберите созданное событие и нажмите "Open Event". У вас откроется заметка отвечающая за выбранную пару. 
		4. **Используйте шаблон**. Перейдите в режим редактирование (карандашик справа сверху) и введите в заметке символ `/` и в открывшемся меню выберите вариант `Шаблоны: Вставить шаблон` и шаблон `Расписание на пару`.
		5. **Укажите нужные свойства**. Про свойства смотрите в блоке ниже. Укажите ссылку на текущую лекцию, практический материал и т.д. (**Важно! Для просмотра всего перечня доступного материала введите квадратные скобки `[[` и найдите то, что вам нужно**)
	2. *Если создана:*
		1. **Выберите нужную пару**. Откройте пару, прокрутите до раздела "Посещаемость" и вставьте в её области шаблон (`/` -> `Шаблоны: Вставить шаблон`) `Список <номер нужной группы>`. Если не получается это сделать — перейдите в режим редактирования (карандашик справа-сверху).
		2. **Отметьте посещаемость**. В созданной таблице отметьте отсутствие студентов, их дежурство и т.д.
