...
Прежде всего, STUDENT — это мой **личный проект**, который я создаю в свободное время. Я не стремлюсь извлекать выгоду из знаний, которыми делюсь в рамках этого проекта.
...
Если вы работаете в группе с другими студентами, то именно здесь будет отображаться предмет, лекция и практическое задание, которое вам нужно сделать в ближайшие дни.

![[Pasted image 20240926090103.png]]

Вы легко сможете определить для себя задание на сегодня и, благодаря ссылкам, перейти к нему.
## Интерактивная среда

> **Интерактивная среда** — специальная область в базе данных, которую могут изменять как студенты, так и преподаватель.
...
Как преподаватель – вы можете забыть о постоянном хаосе в составлении лекций и расписаний. STUDENT позволяет облегчить работу при помощи интерактивной среды и файлового менеджмента.

Но при работе со STUDENT нужно следовать некоторым правилам:

1. **STUDENT представляет собой Open Source проект**. Вам не запрещено изменять уже имеющиеся материал или инструменты, если вы конечно знаете их работу и содержание. STUDENT представляет собой лишь основу, ядро, на котором может строится ваша версия проекта.
...
3. **Учеба в STUDENT не должна быть каторгой**. Эта платформа для удобства, а не для наказания. Вся база данных создана и рассчитана не только на удобство преподавателя, но и для удобства студента. Я пытаюсь следовать правилам по типу «*А как-бы было удобно учится мне, если бы я был студентом*» или  «*А нужно ли читать лекцию по этой занудной теме или предоставить студенту самому ее изучить*». Позволяйте студентам сделать перерыв в пропорциях «*1 час учебы = 15 минут перерыва*»
