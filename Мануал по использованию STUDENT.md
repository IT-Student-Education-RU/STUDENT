...
Для максимального правильности и эффективности ведения пар рекомендуется выполнять следующие действия:

1. Заполнять расписание на сегодня (если оно не заполненно);
2. Отметить отсутствие студентов;
3. 
