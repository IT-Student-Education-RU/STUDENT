...
9. **Измените метаданные заметки**. Это необходимо сделать для корректного отображения расписания на главной странице. Разверните боковое правое окно (кнопка справа сверху), откройте раздел свойств и укажите нужные данные.
