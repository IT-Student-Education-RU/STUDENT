...
Для максимальной правильности и эффективности ведения пар рекомендуется выполнять следующие действия:
...
1. **Заполните пару на сегодняшний день.** 
	1. *Если не создана:*
		...
		2. **Заполните необходимые данные**. Название предмета, номер группы, начало и конец пары. Нажмите "Save Event".
		3. **Откройте созданное событие**. Выберите созданное событие и нажмите "Open Event". У вас откроется заметка отвечающая за выбранную пару и теперь её необходимо заполнить. 
	...
	2. *Если создана:*
		1. **Выберите нужную пару**. Откройте пару, перейдите в раздел "Посещаемость" и поставь
