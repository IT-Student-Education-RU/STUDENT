...
> **Успеваемость** – это раздел с прогрессом в изучении предметов. Он содержит перечень изученных тем, выполненных практик и дополнительных активностей для каждого студента. 
