...
1. **Создайте пару на сегодняшний день (если она не создана)**. Откройте расписание :OcCalendar24: в левом верхнем углу и выберете день на который назначена пара. Для создания достаточно просто кликнуть по пустой области. 
2. **Заполните необходимые данные**. Название предмета, номер группы, начало и конец пары. Нажмите "Save Event".
3. **Откройте созданное событие**. Выберите созданное событие и нажмите 
3. Отметить отсутствие студентов;
